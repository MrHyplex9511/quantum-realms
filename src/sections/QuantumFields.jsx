  ...
  return (
    <section id="fields" ref={sectionRef} style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      >
        ...
        <div style={cardStyle}>
          <QuantumCard title="🌌 What Is a Field?" gradient="cyan" icon="🌊">
          ...
          <QuantumCard title="✨ Particle Excitations" gradient="purple" icon="💫">
          ...
          <QuantumCard title="📋 Standard Model" gradient="cyan-purple" icon="🏛️">
        ...
        >
          ...
          <div>
            <h4 style={{ color: '#ffffff', marginBottom: 8, fontSize: 16 }}>
              The Fabric of Reality
            </h4>
            <p style={{ color: '#888888', fontSize: 14, lineHeight: 1.7 }}>
